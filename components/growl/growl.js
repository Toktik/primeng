...
var Growl = (function () {
    ...
    Growl = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof core_1.ElementRef !== 'undefined' && core_1.ElementRef) === 'function' && _a) || Object, domhandler_1.DomHandler, (typeof (_b = typeof core_1.IterableDiffers !== 'undefined' && core_1.IterableDiffers) === 'function' && _b) || Object])
    ], Growl);
    return Growl;
    var _a, _b;
}());
